...
export const ROLES_INVITABLES = ROLES_STAFF;
...
// ¿Es un rol válido para invitar con rol asignado?
export function esRolInvitable(rol: string | null | undefined): rol is RolStaff {
