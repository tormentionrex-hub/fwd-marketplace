...
const PRODUCTOS: ProductoMarketplace[] = [
  {
    id: "1",
  ...
  },
  {
    ...
    calificacion: 4.8,
    destacado: true,
    tipoProyecto: "Resolución de problemas",
    prioridad: "Alta",
  ...
  },
  {
    ...
    color: "#008fd4",
    calificacion: 4.4,
    lenguajes: ["JavaScript", "TypeScript", "Ruby", "Python"],
    tipoProyecto: "Automatizaciones",
    prioridad: "Alta",
    complejidad: "Avanzado",
  },
  ...
  {
    id: "10",
    nombre: "Plataforma Turismo Digital",
    categoria: "Servicios",
    descripcion: "Sistema de reservas y experiencias turísticas con integración de pagos.",
    precio: "$89 / mes",
    estado: "Nuevo",
    autor: "TurisTech CR",
    color: "#008fd4",
    calificacion: 4.6,
    lenguajes: ["JavaScript", "Next.js", "SQL"],
    tipoProyecto: "Turismo",
    prioridad: "Alta",
    complejidad: "Intermedio",
  },
  {
    id: "11",
    nombre: "Bot de Automatización RR.HH.",
    categoria: "Tecnología",
    descripcion: "Automatiza onboarding, nóminas y evaluaciones con un agente inteligente.",
    precio: "$65 / mes",
    estado: "Disponible",
    autor: "FlowBot",
    color: "#662d91",
  ...
  {
    id: "12",
    nombre: "Guía Skills para Estudiantes",
    categoria: "Educación",
    descripcion: "Roadmaps y recursos para desarrollar habilidades técnicas y blandas.",
    precio: "Gratis",
    estado: "Disponible",
    autor: "FWD Academy",
    color: "#ec008c",
...
/* Productos adicionales para cubrir todos los filtros */
const PRODUCTOS_EXTRA: ProductoMarketplace[] = [
  {
    id: "13",
    nombre: "Ruta Turística Digital CR",
    categoria: "Servicios",
    descripcion: "App para guías turísticos con mapas offline, rutas y pagos integrados.",
    precio: "$55 / mes",
    estado: "Nuevo",
    autor: "TurismoApp",
    color: "#20bec6",
  ...
  {
    id: "14",
    nombre: "Workshop Ruby on Rails",
    categoria: "Educación",
    descripcion: "Taller intensivo de Ruby on Rails para construir APIs REST en 4 semanas.",
    precio: "$95",
    estado: "Disponible",
    autor: "CodeCamp CR",
    color: "#ec008c",
  ...
  {
    id: "15",
    nombre: "Automatizador de Reportes Go",
    categoria: "Tecnología",
    descripcion: "Microservicio en Go para generar reportes PDF/Excel desde cualquier fuente.",
    precio: "$40 / mes",
    estado: "Disponible",
    autor: "GoServices",
    color: "#008fd4",
  ...
  {
    id: "16",
    nombre: "Diagnóstico de Problemas UX",
    categoria: "Servicios",
    descripcion: "Sesión de resolución de problemas de usabilidad con entregables accionables.",
    precio: "$180",
    estado: "Disponible",
    autor: "UXSolve",
    color: "#662d91",
  ...
  {
    id: "17",
    nombre: "Integración Swift iOS",
    categoria: "Tecnología",
    descripcion: "Kit de componentes nativos Swift para apps iOS con diseño FWD.",
    precio: "$75",
    estado: "Nuevo",
    autor: "MobileKit",
    color: "#f7901e",
    calificacion: 4.3,
    lenguajes: ["Swift", "JavaScript"],
    tipoProyecto: "Skills",
    prioridad: "Baja",
    complejidad: "Avanzado",
  },
  {
    id: "18",
    nombre: "Pipeline de Datos con Python",
    categoria: "Innovación",
    descripcion: "Automatización de ingesta y transformación de datos con pandas y Airflow.",
    precio: "$60 / mes",
    estado: "Disponible",
    autor: "DataFlow CR",
    color: "#008fd4",
...
const TODOS_PRODUCTOS = [...PRODUCTOS, ...PRODUCTOS_EXTRA];
export { TODOS_PRODUCTOS as PRODUCTOS };

export const PRODUCTOS_DESTACADOS = TODOS_PRODUCTOS.filter((p) => p.destacado);
