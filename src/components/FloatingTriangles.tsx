...
const TRIANGLES: TriangleDef[] = [
  ...
  /* ── Cómo funciona ── */
  { id: 6,  top: "105%", left: "1%",   size: 76,  color: "#F7901E", opacity: 0.28, rotate: 0,    variant: "double",  floatY: 14, floatRotate: -6,  floatDelay: 0.4,  floatDuration: 5   },
  { id: 7,  top: "118%", left: "93%",  size: 48,  color: "#20BEC6", opacity: 0.35, rotate: 90,   variant: "outline", floatY: 18, floatRotate: 8,   floatDelay: 0.9,  floatDuration: 4.2 },
  { id: 8,  top: "130%", left: "46%",  size: 36,  color: "#662D91", opacity: 0.3,  rotate: -45,  variant: "filled",  floatY: 10, floatRotate: -12, floatDelay: 1.5,  floatDuration: 6   },
  /* ── Proyectos ── */
  { id: 9,  top: "175%", left: "2%",   size: 64,  color: "#FFCB05", opacity: 0.25, rotate: 0,    variant: "double",  floatY: 16, floatRotate: 6,   floatDelay: 0.2,  floatDuration: 5.8 },
  { id: 10, top: "188%", left: "89%",  size: 54,  color: "#ED008C", opacity: 0.32, rotate: 200,  variant: "filled",  floatY: 12, floatRotate: -8,  floatDelay: 0.7,  floatDuration: 4.8 },
  /* ── Características ── */
  { id: 11, top: "238%", left: "91%",  size: 68,  color: "#008FD4", opacity: 0.28, rotate: -15,  variant: "double",  floatY: 14, floatRotate: 10,  floatDelay: 0.5,  floatDuration: 5.2 },
  { id: 12, top: "248%", left: "1%",   size: 42,  color: "#20BEC6", opacity: 0.35, rotate: 25,   variant: "outline", floatY: 18, floatRotate: -6,  floatDelay: 1.2,  floatDuration: 4.6 },
];
