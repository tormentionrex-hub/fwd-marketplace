...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a1a4e] text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              <p className="font-black text-sm uppercase tracking-widest text-white mb-3">Legal</p>
              <Link href="/terminos" className="text-gray-400 text-sm hover:text-white transition-colors block">
                Términos y Condiciones
              </Link>
              <Link href="/privacidad" className="text-gray-400 text-sm hover:text-white transition-colors block mt-2">
          ...
          <div>
            <p className="font-black text-sm uppercase tracking-widest text-white mb-6">Redes Sociales</p>
            <ul className="flex flex-col gap-4">
              <li>
                ...
                >
                  <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-[#1877F2] transition-colors">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors group"
                >
                  <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-[#E1306C] transition-colors">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors group"
                >
                  <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-black transition-colors">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors group"
                >
                  <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-[#25D366] transition-colors">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* ── Columna 3: Hablemos */}
          <div>
            <p className="font-black text-sm uppercase tracking-widest text-white mb-6">Hablemos</p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="mt-2 flex flex-col gap-2">
                <a href="mailto:contacto@fwdcostarica.com" className="flex items-center gap-2 text-gray-400 hover:text-white text-sm transition-colors">
                ...
                <a href="tel:+50672025228" className="flex items-center gap-2 text-gray-400 hover:text-white text-sm transition-colors">
                  <svg className="w-4 h-4 text-[#20BEC6] flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
          ...
          {/* ── Columna 4: Ubicación */}
          <div>
            <p className="font-black text-sm uppercase tracking-widest text-white mb-6">Ubicación</p>
            <a
            ...
            >
              ...
              <img
                src="https://picsum.photos/seed/costarica/400/300"
                alt="Costa Rica"
                className="w-full h-44 object-cover grayscale group-hover:grayscale-0 transition-all duration-500 scale-100 group-hover:scale-105"
              />
