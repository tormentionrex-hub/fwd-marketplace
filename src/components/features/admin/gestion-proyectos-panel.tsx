      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] p-5">
          <span
            ...
            aria-hidden
          />
          <p className="text-sm text-white/50">Proyectos publicados</p>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-orange-500/20 bg-orange-500/5 p-5">
          <span
            ...
            aria-hidden
          />
          <p className="text-sm text-orange-400/70">Pendientes de revisión</p>
          <p className="mt-1 text-3xl font-black tabular-nums text-orange-300">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] p-5">
          <span
            ...
            aria-hidden
          />
          <p className="text-sm text-white/50">Total proyectos</p>
          <p className="mt-1 text-3xl font-black tabular-nums text-white">
            {proyectos.length}
          </p>
        </div>
